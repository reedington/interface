  ...
  async function startRun() {
    ...
    await perform('start', async () => {
      const body = {
        ...
        ...(mode === 'replay' ? { capabilityId: chosenCapability?.id, replayPurpose: chosenCapability?.status === 'draft' ? 'validation' as const : 'execution' as const } : { provider, model: chosenProvider?.model }),
      } satisfies CreateRun;
